...
import conexao.JPA;
import Controladora.EstudanteJpaController;
import Controladora.FuncionarioJpaController;
import Controladora.BLeitorJpaController;
import Controladora.BNotificacaoJpaController;
import Controladora.SgEmprestimoParametrosJpaController;
...
import controlador.paginas.EmailException;
...
public class UtenteController extends SelectorComposer<Component> {
    ...
    /**
     *
     * @throws controlador.paginas.EmailException
     * @throws controlador.paginas.EmailException
     * @throws email.EmailException
     */
...
//    public void doBloqueioV() throws email.EmailException {
...
//    }
    ...
    private void preencherV(BLeitor leitor) {
